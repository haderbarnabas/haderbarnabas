...
![Overview](Retail_Sales_Dashboard_Overview.png)

Egy retail értékesítési és vásárlói viselkedést elemző Excel projekt, amely KPI-számításokra, pivot elemzésekre és vizuális adatmegjelenítésre épül.

**Főbb eredmények:**
- Letisztult, üzleti döntést támogató dashboard kialakítása
- Termékkategóriák teljesítményének összehasonlítása bevétel és mennyiség alapján
- Vásárlói szegmensek elemzése nem és életkor szerint
...
A retail sales analysis project completed in Excel focusing on KPI calculations, customer segmentation, and data visualization to uncover sales trends and customer behavior.

**Key highlights:**
- Built a clean, KPI-driven dashboard
- Analyzed product category performance across revenue and quantity
- Explored customer segments by gender and age
